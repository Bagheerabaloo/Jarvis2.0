...
class TelegramBot:
    ...
    def __send_message(self, chat_id, text, parse_mode=None, reply_mark_up=None, silent=True):
        return self.__safe_execute(lambda: self.bot.send_message(chat_id=chat_id, text=text, parse_mode=parse_mode, reply_markup=reply_mark_up, disable_notification=silent))

    def __send_callback(self, callback_id, text):
        return self.__safe_execute(lambda: self.bot.answer_callback_query(callback_query_id=callback_id, text=text))

    def __send_photo(self, chat_id, photo, caption=None, parse_mode=None, reply_mark_up=None, silent=True):
        return self.__safe_execute(lambda: self.bot.send_photo(chat_id=chat_id, photo=photo, caption=caption, parse_mode=parse_mode, reply_markup=reply_mark_up, disable_notification=silent))

    def __send_document(self, chat_id, document):
        return self.__safe_execute(lambda: self.bot.send_document(chat_id=chat_id, document=document))

    def __edit_message_reply_markup(self, reply_markup, chat_id=None, message_id=None, inline_message_id=None):
        return self.__safe_execute(lambda: self.bot.edit_message_reply_markup(reply_markup=reply_markup, chat_id=chat_id, message_id=message_id, inline_message_id=inline_message_id))

    def __edit_message_text(self, text, reply_markup=None, chat_id=None, message_id=None, inline_message_id=None, parse_mode=None):
        return self.__safe_execute(lambda: self.bot.edit_message_text(text=text, reply_markup=reply_markup, chat_id=chat_id, message_id=message_id, inline_message_id=inline_message_id, parse_mode=parse_mode))

    def __edit_message_media(self, chat_id, media, message_id=None, inline_message_id=None, reply_markup=None):
        return self.__safe_execute(lambda: self.bot.edit_message_media(chat_id=chat_id, message_id=message_id, inline_message_id=inline_message_id, media=media, reply_markup=reply_markup))

    def __edit_message_caption(self, chat_id, caption, message_id=None, inline_message_id=None, reply_markup=None, parse_mode=None):
        return self.__safe_execute(lambda: self.bot.edit_message_caption(caption=caption, reply_markup=reply_markup, chat_id=chat_id, message_id=message_id, inline_message_id=inline_message_id, parse_mode=parse_mode))

    def __delete_message(self, chat_id, message_id):
        return self.__safe_execute(lambda: self.bot.delete_message(chat_id=chat_id, message_id=message_id))
    ...
    def send_message(self, chat_id, text, parse_mode=None, reply_keyboard=None, remove_keyboard=False, inline_keyboard=None, silent=True, pending=False):
        if len(text) == 0:
            return None
        ...
        return self.__send_message(chat_id=chat_id, text=text, parse_mode=parse_mode, reply_mark_up=reply_mark_up, silent=silent)
    ...
    def edit_message(self, text, reply_markup=None, chat_id=None, message_id=None, inline_message_id=None, pending=False, parse_mode=None):
        if len(text) == 0:
            return None
        ...
        return self.__edit_message_text(text=text, reply_markup=reply_markup, chat_id=chat_id, message_id=message_id, inline_message_id=inline_message_id, parse_mode=parse_mode)
...
if __name__ == '__main__':
    ...
    telegram_bot = TelegramBot(token=token, users=users, chats=chats)
    telegram_bot.send_message(chat_id=19838246, text='ciao', inline_keyboard=[['<', '>']])
